        ...
        <div>
          ...
          <div className="space-y-4">
            {sections.map((section) => {
              ...
              const sectionData = t(`doc.sections.${section.key}`);
              const title = sectionData.title;
              const emoji = sectionData.emoji;
              const description = sectionData.description;
              const howToUse = sectionData.howToUse as string[];
        ...
        <div className="surface p-6 rounded-3xl relative overflow-hidden bg-gradient-to-br from-yellow-500/10 to-orange-500/10 border border-yellow-500/20">
          ...
          <div className="relative">
            ...
            <div className="space-y-3">
              {(t("doc.tips.tips") as string[]).map((tip, index) => (
                <div
                  key={index}
